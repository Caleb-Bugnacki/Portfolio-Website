...
export default function Home() {
  return (
    <>
      <div className=" flex justify-between w-full h-screen mx-10 bg ">
        <div className=" flex relative dark:text-white ">
          <div className="flex flex-col leading-10 justify-center">
      ...
      >
        <div className=" flex  my-2 py-10 justify-center">
          <h1 className="text-4xl font-bold font-poppins text-center drop-shadow-2xl uppercase border-b-4 border-gray-500 p-2">
            selected projects
          </h1>
        </div>
        <Carasoul />
